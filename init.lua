...
-- 4 spaces are shown per tab
-- vim.o.tabstop = 4

-- Amount to indent with << and >>
-- vim.o.softtabstop = 4

-- Add 3 lines below makes the diagnosis disappear on statusline
-- vim.o.smarttab = true
...
-- vim.wo.winblend = 10 -- Adjust the value as desired (e.g., 10 for a subtle transparency)
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sa', builtin.builtin, { desc = '[S]earch [A]ll built-in pickers' })
